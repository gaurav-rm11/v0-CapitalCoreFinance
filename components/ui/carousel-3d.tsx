...
const Slide = ({ slide, index, current, handleSlideClick, showDetails = false }: SlideProps) => {
    ...
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        >
          ...
          {description && (
            <p className="text-xs md:text-sm text-white/80 mb-4 max-w-md mx-auto">
              {description}
            </p>
          )}
          ...
          {showDetails && loanAmount && interestRate && tenure ? (
            <div className="mt-4 space-y-3">
              ...
              <div className="flex justify-between items-center text-xs md:text-sm bg-white/95 backdrop-blur-md px-4 py-3 rounded-lg shadow-lg">
                ...
                <span className="font-bold text-accent">{interestRate}</span>
              </div>
              <div className="flex justify-between items-center text-xs md:text-sm bg-white/95 backdrop-blur-md px-4 py-3 rounded-lg shadow-lg">
...
export function Carousel3D({ slides, showDetails = false }: CarouselProps) {
